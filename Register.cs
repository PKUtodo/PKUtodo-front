...
namespace TODO
{
    public partial class Register : Form
    {
        ...
        {
            JObject obj = HTTP.HttpPost(JSONHelper.CreateJson(MessageType.set_up, textBox1.Text, textBox2.Text));
            if(obj != null)
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                JObject obj = HTTP.HttpPost(JSONHelper.CreateJson(MessageType.verify, textBox1.Text, textBox2.Text));
                if (obj != null)
                {
                    if(obj.Value<int>("success") == 1)
                    {
